...
ActiveRecord::Schema.define(version: 20170326144226) do

  create_table "blood_groups", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "group"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group"], name: "index_blood_groups_on_group", unique: true, using: :btree
  end
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["blood_groups_id"], name: "index_users_on_blood_groups_id", using: :btree
  ...
  add_foreign_key "users", "blood_groups", column: "blood_groups_id"
end
